...
import com.trongthien.zbattle.controller.combat.attack.RatfolkAttack;
...
import com.trongthien.zbattle.controller.movement.impl.RandomMovement;
...
public class Ratfolk extends Enemy {
    ...
    protected void setEnemyTileSetPath() {
        enemyTileSetPath = "character/Enemy/Ratfolk.png";
    }
    ...
    protected void setCurrentAttack(EnemyState enemyState) {
        if(enemyState == EnemyState.ATTACK){
            currentAttack = new RatfolkAttack(this);
        }
    }
    ...
    protected void updateMovement() {
        if(enemyState == EnemyState.IDLE){
            ...
            currentMovement = RandomMovement.getInstance();
        }
    }
    ...
    protected void loadFrameInfo() {
        ...
        maxFrame.put(EnemyState.ATTACK, 12);
        maxFrame.put(EnemyState.DIE, 6);
    }

    @Override
    public HitBox getHitBox() {
        return new HitBox(x+28,y,8,8);
    }
}
